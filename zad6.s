...
.LFB9:
	...
	mov	edi, 8
.LEHB0:
//poziv operatora new za Derived
	call	_Znwm@PLT
.LEHE0:
	mov	rbx, rax
	mov	rdi, rbx
.LEHB1:
//poziv konstruktora za Derived
...
//1. poziv konstruktora Derived() unutar koje se prvo poziva
//konstruktor nadređenog razreda Base: pd ima vtable razreda Base
//2. poziv funkcije metoda() unutar konstruktora razreda Derived:
//pd ima vtable razreda Derived
//3. običan poziv funkcije metoda() objekta tipa Derived: vtable 
//razreda Derived
